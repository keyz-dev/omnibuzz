...
const StationsMainView = ({ setView, stations, setStation }) => {
  const navigate = useNavigate();
  const { loading, error, fetchStations } = useAgency();
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-sm">
        ...
        {!loading && !error && (
          viewMode === 'list'
            ? <StationsListView stations={filteredStations} setView={setView} setStation={setStation} onAddWorker={handleOpenAddWorkerModal} />

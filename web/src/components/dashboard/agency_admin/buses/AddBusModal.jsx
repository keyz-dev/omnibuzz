...
import { useAgencyBuses } from "../../../../contexts/dashboard/agency_admin";
import { Input, Button, ModalWrapper } from "../../../ui";

const AMENITIES_LIST = ["Wi-Fi", "AC", "Power Outlet", "Restroom", "TV"];

const AddBusModal = ({ onClose, stations }) => {
  const { createBus, loading, error } = useAgencyBuses();
  ...
  return (
    <ModalWrapper
      isOpen={true}
      onClose={onClose}
      title="Add a new bus to your agency"
    >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between items-center mt-8 gap-4">
            <Button
              ...
              additionalClasses="bg-gray-200 text-gray-800 hover:bg-gray-300"
            >
              Cancel
            </Button>
            <Button
              ...
              isLoading={loading}
              isDisabled={loading}
              additionalClasses="bg-accent text-white hover:bg-accent-dark"
            >
              Add Bus
            </Button>
          </div>
...
const SelectField = ({ label, options, ...props }) => (
  <div className="w-full flex flex-col">
    <label
      ...
      className="block default_transition transform text-base font-medium text-primary z-0 px-2"
    >
      {label}
    </label>
    <select

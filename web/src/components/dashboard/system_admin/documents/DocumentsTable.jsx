        ...
        return (
          <div className="flex items-center gap-3 max-w-[150px]">
            ...
            <div className="flex flex-col gap-1 truncate overflow-hidden">
              ...
              <p className="text-sm text-gray-500 truncate">{row.fileType}</p>
            </div>
          </div>
        );
      },
        ...
        return (
          <div className="flex items-center">
            <img
              ...
              src={row.agency?.avatar || imagePlaceholder}
              alt="Manager"
            />
            <div className="ml-3 flex flex-col gap-2">
              ...
              <div className="text-xs text-gray-500 truncate">
                {row.agency ? row.agency?.owner?.email || "" : ""}
              </div>
            </div>
          </div>
        );
